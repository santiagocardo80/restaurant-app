...
exports.updateStore = async (req, res) => {
  ...
  const updatedStore = await Store.findOneAndUpdate({ _id: id }, body, {
    new: true, // return the new store instead of the old one
    runValidators: true
  }).exec()

  req.flash('success', `Successfully updated <strong>${updatedStore.name}</strong>. <a href="/stores/${updatedStore.slug}">View Store -></a>`)
